...
use PHPMailer\PHPMailer\Exception;
 ...
 if (isset($_POST['approve'])) {
        ...
        $body .= "<p>Don't forget to refer your friends to Winders Coin Investment and earn$ ".$row -> referral_bonus." % of
        ...
        $body .= '<p>Regards,</p>';
        $body .= '<p>Admin.</p>';
        $body .= '<p><a href="https://winderscoin.com">Winders Coin</a></p>';
